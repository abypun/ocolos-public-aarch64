 ...
 * correctly.
 */
void print_err_and_exit(FILE *recordFile, std::string func, long addr, long len, long page);
...
extern "C" int __libc_start_main(void *orig_main, int argc, char *argv[], void (*init_func)(void),
                                 void (*fini_func)(void), void (*rtld_fini_func)(void), void *stack_end);
